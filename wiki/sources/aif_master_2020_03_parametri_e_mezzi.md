...
# AIF Master 2020 — 03. Parametri e mezzi dell'allenamento

- **Provenienza:** [`raw/courses/AIF/trascrizione_aif_riformattata.md`](raw/courses/AIF/trascrizione_aif_riformattata.md) — trascrizione riformattata a partire da `raw/courses/AIF/Copia di MASTER PROGRAMMAZIONE-2020 (AIF) (1).pdf` (PDF originale con content stream corrotti, non ri-processabile via OCR).
- **Corso:** [[aif]] · MASTER PROGRAMMAZIONE — Parma 2020
- **Data corso:** 2020-09-19
...
- **Intensità** (% sul massimale)
- **Volume** (numero totale di ripetizioni)
- **Frequenza** (numero di sessioni)
...
- 80% × 5 rip.
- Se il 5RM ipotetico vale 86 kg, l'IR nella prima serie è ≈ 93%.

## Mezzi metodologici

### Rapporto percentuali / ripetizioni

- Ripetizioni possibili vs ripetizioni ideali (buffer)
- Significato della %
- Lavorare sopra la soglia ideale o in soglia

### Carico fisso

- Mezzo costruttore
- Genera volume di qualità
- Mezzo stabilizzatore ("repetita iuvant")

### Piramidale

- Mezzo stimolante
- Progressione dello stimolo
- Intensità relativa tendente allo stabile

### Ramping (MAV / RPE)

- Autoregolazione
- Specificità rispetto al test
- Reazione al carico
- Allena l'estrapolazione

### Back-off e back-off alla rovescia

- **Back-off:** post-attivazione — prima si stimola, poi si stabilizza.
- **Alla rovescia:** solid base e poi sviluppo in alto — prima si stabilizza, poi si stimola.

## Mezzi tecnici extra

- Isocinetiche
- Isometriche
- Variazione di angoli di lavoro
- Variazione di range di lavoro
